	...
	var NVD3Chart = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(NVD3Chart, [{
	    ...
	    value: function renderChart() {
	      ...
	      if (this.props.legend && this.props.legend.legendClick) this.chart.legend && this.chart.legend.dispatch && this.chart.legend.dispatch.on("legendClick", this.legendClick.bind(this));
	      if (this.props.legend && this.props.legend.legendDblclick) this.chart.legend && this.chart.legend.dispatch && this.chart.legend.dispatch.on("legendDblclick", this.legendDblclick.bind(this));
	      this.rendering = true;
	    ...
	    key: 'legendClick',
	    value: function legendClick(e, a) {
	      if ((0, _utils.isCallable)(this.props.legend.legendClick)) this.props.legend.legendClick(this.chart, 'legendClick');
	    }
	    ...
	    key: 'legendDblclick',
	    value: function legendDblclick(series, index) {
	      if ((0, _utils.isCallable)(this.props.legend.legendDblclick)) this.props.legend.legendDblclick(this.chart, 'legendDblclick');
	    }

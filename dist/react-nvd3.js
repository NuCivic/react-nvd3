...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nvd3 = __webpack_require__(42);

	var _nvd32 = _interopRequireDefault(_nvd3);

	var SETTINGS = ['x', 'y', 'width', 'height', 'type', 'datum'];
	  ...
	  _createClass(Chart, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _nvd32['default'].addGraph(function () {
	        _this.chart = _nvd32['default'].models[_this.props.type]().x(_this.getValueFunction(_this.props.x, 'x')).y(_this.getValueFunction(_this.props.y, 'y')).margin(_this.propsByPrefix('margin-') || {}).options(_this.getChartOptions());
	    ...
	    value: function getChartOptions() {
	      ...
	      _Object$keys(this.props).forEach(function (prop) {
	        if (SETTINGS.indexOf(prop) < 0) options[prop] = _this2.props[prop];
	      });
	      return options;
	    }
	  }, {
	    ...
	    value: function propsByPrefix(prefix) {
	      ...
	      return _Object$keys(this.props).reduce(function (memo, prop) {
	    ...
	    value: function render() {
	      ...
	      ['width', 'height'].forEach(function (x) {
	        if (_this4.props[x]) opts[x] = _this4.props[x];
	      });
	      return _react2['default'].createElement(
	        'div',
	        { ref: 'root', className: 'nv-chart' },
	        _react2['default'].createElement('svg', _extends({ ref: 'svg' }, opts))
	      );
	    }
	  }]);
